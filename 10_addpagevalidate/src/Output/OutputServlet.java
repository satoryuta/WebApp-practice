...
@WebServlet(urlPatterns={"/kadai10/sts"})
public class OutputServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,
		...
		boolean resultCheck = validator.requireCheck(title, writer, price, genre);
		...
		out.println("    <form action=\"http://localhost:8080/10_addpagevalidate/greeting-in.jsp\">");
		out.println("      <table>");
